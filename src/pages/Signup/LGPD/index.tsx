            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Asterisk Holdings, 1 Cupertino, CA 95014.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Hotel Asterisk, accessible from{' '}
                  <a href='https://hotelasterisk.hue' target='_blank' rel='noreferrer'>
                    https://hotelasterisk.hue
                  </a>
                </p>
              </li>
              <li>
